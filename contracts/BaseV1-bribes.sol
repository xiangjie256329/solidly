...
contract Bribe {
    ...
    */
    ...
    // used by BaseV1Voter to allow batched reward claims,voter
    ...
    // used to notify a gauge/bribe of a given reward, this can create griefing attacks by extending rewards fee会主动放进来,也可以项目方自己放,比如没有得到奖励分配的奖池
